...
"[project]/src/app/items/[id]/page.jsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ItemDetails() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        fetch(`http://localhost:5000/api/products/${params.id}`).then((res)=>res.json()).then((data)=>setProduct(data));
    }, [
        params.id
    ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7b6ad0e5._.js.map