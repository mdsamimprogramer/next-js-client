(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  "[project]/src/components/AuthForm.jsx [app-client] (ecmascript)",
  (__turbopack_context__) => {
    "use strict";

    __turbopack_context__.s(["default", () => AuthForm]);
    ...
    function AuthForm(t0) {
      ...
      if (
        $[0] !==
        "4ef920cbdf99975218771d8c91cf53f26f6ee1364f5334151bd60370714d33cc"
      ) {
          ...
          "AuthForm[handleSubmit]": async (e) => {
            ...
            if (type === "register") {
              const res = await fetch(
                "https://server-sage-gamma.vercel.app/api/register",
                {
                  method: "POST",
                  headers: {
      ...
      if ($[11] !== loading || $[12] !== t7) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
          ...
          "button",
          {
            type: "submit",
            className:
              "px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700 w-full",
            disabled: loading,
            children: t7,
          },
          void 0,
      ...
      if ($[14] === Symbol.for("react.memo_cache_sentinel")) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
          ...
          "button",
          {
            ...
            className:
              "px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 w-full",
  ...
  "[project]/src/app/auth/login/page.jsx [app-client] (ecmascript)",
  (__turbopack_context__) => {
    "use strict";
    ...
    var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$AuthForm$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ =
      __turbopack_context__.i(
        "[project]/src/components/AuthForm.jsx [app-client] (ecmascript)"
      );
    ("use client");
    function LoginPage() {
      ...
      if (
        $[0] !==
        "a0f3fe473ea79c85c61789b04ffd0be6b53ed960db3bb168ce89a3fcd7986bdd"
      ) {
        for (let $i = 0; $i < 2; $i += 1) {
          $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
          ...
          "div",
          {
            ...
            children: [
              ...
              __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$AuthForm$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
                  "default"
                ],
                {
                  type: "login",
