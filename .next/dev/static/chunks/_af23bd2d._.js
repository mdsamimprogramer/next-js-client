(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  "[project]/src/app/items/[id]/page.jsx [app-client] (ecmascript)",
  (__turbopack_context__) => {
    "use strict";

    __turbopack_context__.s(["default", () => ItemDetails]);
    ...
    function ItemDetails() {
      ...
      if (
        $[0] !==
        "2526d1675bc2a2dff65e543b6a155ae2ee69291583372015aecc8ed775cb6e51"
      ) {
      ...
      if ($[1] !== params.id) {
        t0 = {
          "ItemDetails[useEffect()]": () => {
            fetch(
              `https://server-sage-gamma.vercel.app/api/products/${params.id}`
            )
              .then(_ItemDetailsUseEffectAnonymous)
              .then(
                {
                  "ItemDetails[useEffect() > (anonymous)()]": (data) =>
                    setProduct(data),
